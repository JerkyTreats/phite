// Package config provides centralized, extensible configuration loading for vibe_health_BACKEND using spf13/viper.
...
func loadConfig() (*viper.Viper, error) {
	...
	v.AddConfigPath(os.ExpandEnv("$HOME/.vibe-health"))
	if configPath != "" {
