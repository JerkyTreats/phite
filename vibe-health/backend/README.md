# github.com/JerkyTreats/PHITE/vibe-health/backend
...
```bash
# Build image
docker build -t github.com/JerkyTreats/PHITE/vibe-health/backend .

# Run container
docker run -p 8080:8080 github.com/JerkyTreats/PHITE/vibe-health/backend
```
