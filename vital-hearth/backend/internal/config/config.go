// Package config provides centralized, extensible configuration loading for VITAL_HEARTH_BACKEND using spf13/viper.
...
func loadConfig() (*viper.Viper, error) {
	...
	v.AddConfigPath(os.ExpandEnv("$HOME/.vital-hearth"))
	if configPath != "" {
